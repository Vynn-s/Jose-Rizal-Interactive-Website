    ...
    <div className="relative w-64 h-64 mx-auto mb-8">
      ...
      <div className="absolute inset-4 rounded-full bg-gradient-to-br from-[#3B2314] to-[#5a4030] overflow-hidden">
        ...
        >
          ...
          {/* Hair */}
          <path
            d="M 65 60 Q 65 35, 100 30 Q 135 35, 135 60 L 135 85 Q 130 80, 125 82 Q 120 70, 115 75 Q 110 65, 105 70 Q 100 60, 95 70 Q 90 65, 85 75 Q 80 70, 75 82 Q 70 80, 65 85 Z"
            fill="#1a1410"
          />
          ...
          {/* Mustache */}
          <path
            d="M 85 98 Q 92 100, 100 99 Q 108 100, 115 98"
            stroke="#1a1410"
            strokeWidth="2"
            fill="none"
          />
          ...
          {/* Collar/Shirt */}
          <path
            d="M 70 135 L 88 125 L 88 200 L 70 200 Z"
            fill="#E8E0D5"
          />
          <path
            d="M 130 135 L 112 125 L 112 200 L 130 200 Z"
            fill="#E8E0D5"
          />
          ...
          {/* Lapels */}
          <path
            d="M 75 145 L 90 145 L 90 200 L 75 200 Z"
            fill="#2a1810"
          />
          <path
            d="M 110 145 L 125 145 L 125 200 L 110 200 Z"
            fill="#2a1810"
          />
